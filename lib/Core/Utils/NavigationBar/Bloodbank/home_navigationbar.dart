...
class BloodBankHomeNavigationBar extends StatefulWidget {
...
class CurvedNavigationBarState extends State<BloodBankHomeNavigationBar>
  ...
  @override
  void didUpdateWidget(BloodBankHomeNavigationBar oldWidget) {
        ...
        builder: (context, constraints) {
          final maxWidth = min(
              constraints.maxWidth, widget.maxWidth ?? constraints.maxWidth);
                 ...
                 final clampScaled = textScale.clamp(1.0, 1.2);
               return MediaQuery(
                 data: MediaQuery.of(context).copyWith(
                   textScaleFactor: clampScaled,
                 ),
                 child: Align(
