...
class IPBloodRequest extends StatefulWidget {
  final String patientName;
  final String crn;

  const IPBloodRequest({
    super.key,
  ...
  @override
  State<IPBloodRequest> createState() => _IPInfectionRecState();
}

class _IPInfectionRecState extends State<IPBloodRequest> {
  ...
  Widget _buildBloodRequistionNo() {
    return CustomExpansionFrame(
