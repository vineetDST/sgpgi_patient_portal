...
class IPPrevMaterialScreen extends StatefulWidget {
  final String patientName;
  final String crn;

  const IPPrevMaterialScreen({
    super.key,
  ...
  @override
  State<IPPrevMaterialScreen> createState() => _PrevMaterialScreenState();
}

class _PrevMaterialScreenState extends State<IPPrevMaterialScreen> {
  // Controllers
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () => _showMaterialFilterSidebar(context),
                    child: const Icon(
