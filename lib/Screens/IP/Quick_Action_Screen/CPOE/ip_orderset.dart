...
import '../../../../Core/Utils/Modals/order_remarks_field.dart';

// --- ADDED IMPORT FOR THE NEW COMPONENT ---
// import 'order_remarks_field.dart'; // Adjust path as necessary
...
class _OrderSetScreenState extends State<IPOrderSetScreen> {
  ...
  // Test On Controllers
  final TextEditingController _testOn1 = TextEditingController(text: "Blood - Plain");
  final TextEditingController _testOn2 = TextEditingController(text: "Blood - Plain");
  ...
  Widget _buildServiceColumn(
      ...
      String priority,
      String center,
      TextEditingController testOnCtrl,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildPlainInputCell("Test On", testOnCtrl, 60),
          // --- UPDATED: Using the new Component ---
          OrderRemarksField(controller: remarksCtrl, cellHeight: 60),
                        ...
                        child: Column(
                          children: [
                            ...
                            ...entry.value.asMap().entries.map(
                                  (mapEntry) {
                                int index = mapEntry.key; // Isse hume current index mil jayega
                                var item = mapEntry.value; // Isse hume data mil jayega

                                // Check karenge ki kya yeh list ka aakhri element hai
                                ...
                                return Column(
                                  children: [
                                      ...
                                      child: item.isEmpty
                                        ...
                                        children: [
                                          SizedBox(
                                            ...
                                            width: 20,
                                            child: Checkbox(
                                              value: testSelections[item],
                                              activeColor: const Color(0xFF117A7A),
                                              onChanged: (v) {
                                                setState(() {
                                                  testSelections[item] = v ?? false;
                                                });
                                              },
                                            ),
                                          ),
                                    ...
                                    // Agar last element hai toh SizedBox(), nahi toh Divider
                                    isLast
                                        ? const SizedBox()
                                        : Divider(
                                      height: 1,
    ...
    return Column(
      ...
      children: [
        ...
        FunctionalDropdown(
          value: _department,
          hint: "--Select--",
          items: const ["--Select--", "Department", "Consultant"],
        ...
        FunctionalDropdown(
          value: _type,
          hint: "--Select--",
          items: const ["--Select--", "Emergency", "Elective"],
