...
class IPGeneral extends StatefulWidget {
  final String patientName;
  final String crn;
  const IPGeneral({super.key, required this.patientName, required this.crn});

  @override
  State<IPGeneral> createState() => _InvestigationScreenState();
}

class _InvestigationScreenState extends State<IPGeneral> {
  // Main Screen States
    ...
    return IpBaseScaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          // Bottom Buttons
          _buildFullWidthButton("Save Order", isPrimary: true, onTap: () {}),
  ...
  Widget _buildFlippedTable() {
    ...
    Widget leftCell(String label) => Container(
      height: rowHeight,
  ...
  Widget _dataCell(Widget child, {bool alignCenter = false,bool removePadding = false}) {
    return Container(
      height: 60,
      padding: removePadding ? EdgeInsets.zero : const EdgeInsets.symmetric(horizontal: 12),
