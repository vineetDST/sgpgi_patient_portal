...
class IPPrescriptionScreen extends StatefulWidget {
  final String patientName;
  final String crn;

  const IPPrescriptionScreen({
    super.key,
  ...
  @override
  State<IPPrescriptionScreen> createState() => _PrescriptionScreenState();
}

class _PrescriptionScreenState extends State<IPPrescriptionScreen> {
    ...
    return IpBaseScaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFullWidthButton("Add Drug", isFilled: true, isFullWidth: false),
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          ...
          // CustomRemarksField(hintText: 'Instruction',title: 'Instruction',),
          _buildDivider(),
          Container(
            height: 55,
            alignment: Alignment.centerLeft,
  ...
  Widget _buildFullWidthButton(
    ...
    return SizedBox(
      ...
      height: 48,
      child: isFilled && !isFullWidth
          ? GestureDetector(
              onTap: () {},
              child: Center(
                child: Container(
                  // Padding text ke aaspas space banayegi (left/right me zyada, top/bottom me kam)
                  padding: const EdgeInsets.symmetric(
                    horizontal: 40,
                    vertical: 12,
                  ),
                  ...
                  child: Text(
                    text, // Yahan "Add Drug" pass karein
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize:
                          16, // Thoda bada font size image se match karne ke liye
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                ),
