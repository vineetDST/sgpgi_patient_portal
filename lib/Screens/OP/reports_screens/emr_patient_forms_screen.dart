...
class EmrPatientFormsScreen extends StatefulWidget {
  final String patientName;
  final String crn;
  final String? mode;
  const EmrPatientFormsScreen({
    super.key,
  ...
  @override
  State<EmrPatientFormsScreen> createState() => _EmrPatientFormsScreenState();
}

class _EmrPatientFormsScreenState extends State<EmrPatientFormsScreen> {
  @override
