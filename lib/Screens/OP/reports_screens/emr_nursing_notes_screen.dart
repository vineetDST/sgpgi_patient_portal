...
class EmrNursingNotesScreen extends StatefulWidget {
  final String patientName;
  final String crn;
  final String? mode;
  const EmrNursingNotesScreen({
    super.key,
  ...
  @override
  State<EmrNursingNotesScreen> createState() => _EmrNursingNotesScreenState();
}

class _EmrNursingNotesScreenState extends State<EmrNursingNotesScreen> {
  @override
