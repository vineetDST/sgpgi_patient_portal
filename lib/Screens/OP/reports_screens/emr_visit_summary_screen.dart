...
class EmrVisitSummaryScreen extends StatefulWidget {
  final String patientName;
  final String crn;
  final String? mode;
  const EmrVisitSummaryScreen({
    super.key,
  ...
  @override
  State<EmrVisitSummaryScreen> createState() => _EmrVisitSummaryScreenState();
}

class _EmrVisitSummaryScreenState extends State<EmrVisitSummaryScreen> {
  @override
