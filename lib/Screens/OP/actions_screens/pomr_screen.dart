...
class PomrScreen extends StatefulWidget {
  final String patientName;
  final String crn;

  const PomrScreen({super.key, required this.patientName, required this.crn});

  @override
  State<PomrScreen> createState() => _PomrScreenState();
}

class _PomrScreenState extends State<PomrScreen> {
