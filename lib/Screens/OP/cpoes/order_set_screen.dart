...
class OrderSetScreen extends StatefulWidget {
  final String patientName;
  final String crn;

  const OrderSetScreen({
    super.key,
  ...
  @override
  State<OrderSetScreen> createState() => _OrderSetScreenState();
}

class _OrderSetScreenState extends State<OrderSetScreen> {
  ...
  final TextEditingController _testOn1 = TextEditingController(
    text: "Blood - Plain",
  );
  final TextEditingController _testOn2 = TextEditingController(
    text: "Blood - Plain",
  );
