...
class RxPrintingScreen extends StatefulWidget {
  final String patientName;
  final String crn;
  const RxPrintingScreen({
    super.key,
    required this.patientName,
    required this.crn,
  });
  @override
  State<RxPrintingScreen> createState() => _RxPrintingScreenState();
}

class _RxPrintingScreenState extends State<RxPrintingScreen> {
