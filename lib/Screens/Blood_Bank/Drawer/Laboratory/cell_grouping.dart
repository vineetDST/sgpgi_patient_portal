...
class CellGrouping extends StatefulWidget {
  CellGrouping({super.key});

  @override
  State<CellGrouping> createState() => _BloodBankHomeState();
}

class _BloodBankHomeState extends State<CellGrouping> {
    ...
    return BloodBankBaseScaffold(
      ...
      child: Column(
        children: [
          ...
          AppCancelButton(text: 'Cell Grouping Antisera Details', onPressed: (){
             AppDialog.show(
                 context: context,
                 title: 'Cell Grouping Antisera Details',
     ...
     return ScrollableDataTable(
       showPagination: true,
         ...
         tableLabels: const [
           ...
           TableLabel(text: 'Anti-H'),
           TableLabel(text: 'Anti-A'),
           TableLabel(text: 'Anti-B'),
           TableLabel(text: 'Anti-AB'),
           TableLabel(text: 'D1'),
           TableLabel(text: 'D2'),
           TableLabel(text: 'DU'),
           TableLabel(text: 'ABO'),
           TableLabel(text: 'Rh'),
           TableLabel(text: 'Genotype'),
