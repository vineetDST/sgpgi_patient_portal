...
import 'package:qc_hospital/Screens/Blood_Bank/Drawer/Procedure/procedure_details.dart';
...
class PlateletPheresis extends StatefulWidget {
  PlateletPheresis({super.key});
  @override
  State<PlateletPheresis> createState() => _BloodBankHomeState();
}

class _BloodBankHomeState extends State<PlateletPheresis> {
  ...
  Widget build(BuildContext context) {
    return BloodBankBaseScaffold(
      title: "Patient Pheresis Browser",
      showDrawer: true,
      child: Column(
        children: [
          Align(
        ...
        [
          GestureDetector(
              onTap: (){
                ...
                bloodBankShellKey.currentState?.pushToCurrentTab(ProcedureDetails());
              },
              child: const Text( 'Enter Procedure Details', style: TextStyle(fontSize: 13,color:  const Color(0xFF117A7A,),),)
          ),
          GestureDetector(
              onTap: (){
